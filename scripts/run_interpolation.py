...
def run_interpolation(data, interpolation_mode: str, run_dir: Path, scale: int):
    ...
    truth = data[f'truth_24']
    in_data = data[f'in_24']
    ...
    prediction = interpolation_grid(in_data, 24, scale, interpolation_mode)
    np.savez(run_dir.joinpath('pred.npz'),
             truth_32=data[f'truth_24'],
             coords_32=data[f'coords_24'],
             pred_32=prediction,
             in_32=data[f'in_24'])
